    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            */
            ...
            //CAMBIAMOS SU ID
            factura1.setNumero(26);
            //Hacemos un merge en lugar de un persist
            entityManager.merge(factura1);

            //Cambiamos el precio de un artículo
            Articulo articulo1 = entityManager.find(Articulo.class, 1L);
            articulo1.setPrecio(2500);
            entityManager.merge(articulo1);

            /* EJEMPLO: ELIMINAMOS UN ARTÍCULO
            Articulo articulo4 = entityManager.find(Articulo.class, 4L);
            entityManager.remove(articulo4);
             */

            /* Los cambios que realicemos se verán reflejados en nuestra base de datos:
            En la tabla "REVISION_INFO" tendremos una nueva fila con el id y fecha correspondiente a las
            modificaciones realizadas.
            En las tablas con extensión _AUD podremos ver el número de revisión correspondiente al id del objeto
            modificado y también el REVTYPE correspondiente.
            --- TIPOS DE REVTYPE ---
            0: Alta
            1: Modificación
            2: Baja
